...
namespace LumenFX.Infrastructure
{
    ...
    internal static class PropertyLedger
    {
        ...
        internal static void Write(object target, string path, object value, string owner = "LumenFX")
        {
        ...
        internal static void Release(object target, string path, string owner = "LumenFX")
        {
            if (target == null) return;
        ...
        internal static void ReleaseAll(string owner = "LumenFX")
        {
        ...
        internal static void Forget(string owner = "LumenFX")
        {
            foreach (var target in new List<object>(Entries.Keys))
            {
