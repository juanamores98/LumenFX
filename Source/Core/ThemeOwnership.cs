...
namespace LumenFX.Core
{
    ...
    /// la dispersión Rayleigh de 1.016 a 1.116 y la Mie de 2.549 a 1.858,
    /// que son valores del tema.
    ///
    ...
    internal static class ThemeOwnership
    {
        ...
        private static bool Detect()
        {
            ...
            {
                Debug.Log("[LumenFX] no se pudo comprobar el gestor de temas -> " + e.Message);
            }
